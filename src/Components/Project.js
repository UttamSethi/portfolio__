  ...
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900">
      ...
      <div className="dark:bg-dark-card p-4">
        <h1 className="dark:text-amber-200 font-semibold text-lg pt-1">{title}</h1>
        <p className="text-cyan-100 pt-4 font-light">{description}</p>
        <h3 className="text-dark-heading dark:text-lime-200 font-medium pt-4">
        ...
        <div className="flex justify-between items-center mt-5">
          <div className="flex items-center">
            ...
            {/* <a
              ...
              className="underline pl-2 font-bold dark:text-amber-400"
            >
              Live Preview
            </a> */}
          </div>
          <div className="flex items-center">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="underline pl-2 font-bold dark:text-teal-400"
            >
              View Code
            </a>
          </div>
